...
class VocabParallelEmbedding(nn.Module):
    ...
    def __init__(self, num_embeddings: int, embedding_dim: int, tp_size: int = 2) -> None:
        super().__init__()
        if num_embeddings <= 0:
    ...
    @classmethod
    def from_embedding(cls, embedding: nn.Embedding, tp_size: int = 2) -> "VocabParallelEmbedding":
        layer = cls(embedding.num_embeddings, embedding.embedding_dim, tp_size=tp_size)
